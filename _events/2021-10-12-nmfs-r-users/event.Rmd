...
1. What do we want this R Users group to do? 

   - All things R across all of NOAA? 
   - Tutorial sharing? 
   - Reading group? 
   - Lightning talks? 
...
2. Topics we would like to see discussed this quarter. Examples
   ...
   - {Targets}	Tutorial
   - {NMFSReports} - can we work on something like this together?	     - Lightning talks about how we write reports with R Markdown. Pros and Cons?	Presentation + Discussion
   - {testthat} Tutorial
   - {googledrive} Tutorial

3. How often we would like to meet.

4. Then we'll have a short presentation on a cool topic.
